<script lang='ts'>
    ...
    function toggleMovileNav(to: boolean) {
        ...
        setTimeout(()=>{ mobileNav = to }, 150);
    } 
</script>


<div id='NavBar' class='fixed w-full h-20 md:h-16 shadow-lg bg-black bg-opacity-30 flex justify-between items-center text-white'>
    <!-- Dark mode button -->
    <DarkMode/>
