...
<Suspense final>
	...
	<Moon position={[200, 0, 0]}/>

</Suspense>

<!-- Camera -->
<T.PerspectiveCamera position={[30, 5, 15]} zoom={1} fov={30} near={0.1} far={20000} makeDefault>
	<OrbitControls autoRotate={true} autoRotateSpeed={0} enableZoom={true} zoomSpeed={1} enableDamping/>
