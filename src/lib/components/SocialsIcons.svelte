<script>
    import { LinkedinSolid, GithubSolid, EnvelopeOutline, NewspapperOutline } from 'flowbite-svelte-icons';
</script>

<!-- Icons -->
<div id='SocialsIcons' class='hidden sm:block fixed top-[35%] left-0 flex flex-col text-2xl text-white'>
    <!-- LinkedIn -->
